...
The .yaml files use the JSON-compatible subset of YAML 1.2, so they can be parsed without a YAML dependency. Each resource appears once in its registry, with a direct url field. The root README is a view of these records.
...
- surveys.yaml: surveys and tutorials.
